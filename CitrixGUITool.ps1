...
Get-BrokerApplication -AdminAddress $DDC -MaxRecordCount 100000 | Select * | Export-Csv -Path ("c:\temp\" + $OutPath + "_Report.csv")  -NoTypeInformation

## Create total list incl all information to TXT
Get-BrokerApplication -AdminAddress $DDC -MaxRecordCount 100000 | Select * | Out-file -FilePath ("c:\temp\" + $OutPath + "_Report.txt")

## Create total list incl all information to EXCEL
Get-BrokerApplication -AdminAddress $DDC -MaxRecordCount 100000 | Select * | Export-Excel -path ("c:\temp\" + $OutPath + "_Report.xlsx") -worksheetname "$OutPath" -TableStyle Medium16 -AutoSize


## The following lines are just showing alle the properties names you can choose

## Create total list incl all information to CSV
#Get-BrokerApplication -AdminAddress $DDC -MaxRecordCount 100000 | Select AdminFolderName,AdminFolderUid,AllAssociatedDesktopGroupUUIDs,AllAssociatedDesktopGroupUids,ApplicationName,ApplicationType,AssociatedApplicationGroupUUIDs,AssociatedApplicationGroupUids,AssociatedDesktopGroupPriorities,AssociatedDesktopGroupUUIDs,AssociatedDesktopGroupUids,AssociatedUserFullNames,@{l="AssociatedUserNames";e={$_.AssociatedUserNames -join ","}},@{l="AssociatedUserSIDs";e={$_.AssociatedUserSIDs -join ","}},@{l="AssociatedUserUPNs";e={$_.AssociatedUserUPNs -join ","}},BrowserName,ClientFolder,CommandLineArguments,CommandLineExecutable,ConfigurationSlotUids,CpuPriorityLevel,Description,Enabled,HomeZoneName,HomeZoneOnly,HomeZoneUid,IconFromClient,IconUid,IgnoreUserHomeZone,LocalLaunchDisabled,MachineConfigurationNames,MachineConfigurationUids,MaxPerMachineInstances,MaxPerUserInstances,MaxTotalInstances,MetadataKeys,MetadataMap,Name,PublishedName,SecureCmdLineArgumentsEnabled,ShortcutAddedToDesktop,ShortcutAddedToStartMenu,StartMenuFolder,Tags,UUID,Uid,UserFilterEnabled,Visible,WaitForPrinterCreation,WorkingDirectory | Export-Csv -Path ("c:\temp\" + $OutPath + "_Report.csv")  -NoTypeInformation

## Create total list incl all information to TXT
#Get-BrokerApplication -AdminAddress $DDC -MaxRecordCount 100000 | Select AdminFolderName,AdminFolderUid,AllAssociatedDesktopGroupUUIDs,AllAssociatedDesktopGroupUids,ApplicationName,ApplicationType,AssociatedApplicationGroupUUIDs,AssociatedApplicationGroupUids,AssociatedDesktopGroupPriorities,AssociatedDesktopGroupUUIDs,AssociatedDesktopGroupUids,AssociatedUserFullNames,@{l="AssociatedUserNames";e={$_.AssociatedUserNames -join ","}},@{l="AssociatedUserSIDs";e={$_.AssociatedUserSIDs -join ","}},@{l="AssociatedUserUPNs";e={$_.AssociatedUserUPNs -join ","}},BrowserName,ClientFolder,CommandLineArguments,CommandLineExecutable,ConfigurationSlotUids,CpuPriorityLevel,Description,Enabled,HomeZoneName,HomeZoneOnly,HomeZoneUid,IconFromClient,IconUid,IgnoreUserHomeZone,LocalLaunchDisabled,MachineConfigurationNames,MachineConfigurationUids,MaxPerMachineInstances,MaxPerUserInstances,MaxTotalInstances,MetadataKeys,MetadataMap,Name,PublishedName,SecureCmdLineArgumentsEnabled,ShortcutAddedToDesktop,ShortcutAddedToStartMenu,StartMenuFolder,Tags,UUID,Uid,UserFilterEnabled,Visible,WaitForPrinterCreation,WorkingDirectory | Out-file -FilePath ("c:\temp\" + $OutPath + "_Report.txt")

## Create total list incl all information to EXCEL
#Get-BrokerApplication -AdminAddress $DDC -MaxRecordCount 100000 | Select AdminFolderName,AdminFolderUid,AllAssociatedDesktopGroupUUIDs,AllAssociatedDesktopGroupUids,ApplicationName,ApplicationType,AssociatedApplicationGroupUUIDs,AssociatedApplicationGroupUids,AssociatedDesktopGroupPriorities,AssociatedDesktopGroupUUIDs,AssociatedDesktopGroupUids,AssociatedUserFullNames,@{l="AssociatedUserNames";e={$_.AssociatedUserNames -join ","}},@{l="AssociatedUserSIDs";e={$_.AssociatedUserSIDs -join ","}},@{l="AssociatedUserUPNs";e={$_.AssociatedUserUPNs -join ","}},BrowserName,ClientFolder,CommandLineArguments,CommandLineExecutable,ConfigurationSlotUids,CpuPriorityLevel,Description,Enabled,HomeZoneName,HomeZoneOnly,HomeZoneUid,IconFromClient,IconUid,IgnoreUserHomeZone,LocalLaunchDisabled,MachineConfigurationNames,MachineConfigurationUids,MaxPerMachineInstances,MaxPerUserInstances,MaxTotalInstances,MetadataKeys,MetadataMap,Name,PublishedName,SecureCmdLineArgumentsEnabled,ShortcutAddedToDesktop,ShortcutAddedToStartMenu,StartMenuFolder,Tags,UUID,Uid,UserFilterEnabled,Visible,WaitForPrinterCreation,WorkingDirectory | Export-Excel -path ("c:\temp\" + $OutPath + "_Report.xlsx") -worksheetname "$OutPath" -TableStyle Medium16 -AutoSize
...
# Input only the filename without extension              
              ...
              $ToExcel | Export-Excel -path ("c:\temp\" + $OutPath + "_Report.xlsx") -worksheetname "$OutPath" -TableStyle Medium16
